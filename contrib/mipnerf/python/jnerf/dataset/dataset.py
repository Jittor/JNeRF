...
#     def __init__(self, root_dir, batch_size, mode='train', H=0, W=0, near=0., far=1., correct_pose=[1, -1, -1],
#                  aabb_scale=None, offset=None, img_alpha=True, have_img=True, preload_shuffle=True):
#         self.root_dir = root_dir
#         self.batch_size = batch_size
#         self.preload_shuffle = preload_shuffle
#         self.H = H
